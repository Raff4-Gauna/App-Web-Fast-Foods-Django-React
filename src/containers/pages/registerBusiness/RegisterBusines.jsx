  ...
  const navigate = useNavigate();
    ...
    const validateForm = () => {
      ...
      if (formData.images === null) {
        newErrors.images = 'Debes seleccionar una imagen';
      }
    ...
    const handleSubmit = async (e) => {
      ...
      if (Object.keys(newErrors).length > 0) {
        ...
        formDataToSubmit.append('email_business', formData.email_business);
        formDataToSubmit.append('attention_schedule', formData.attention_schedule);
            ...
            <div className="pt-28">
                <div className="relative bg-white">
                    ...
                    <div className="relative mx-auto max-w-7xl lg:grid lg:grid-cols-5">
                        ...
                        <div className="bg-white py-16 px-4 sm:px-6 lg:col-span-3 lg:py-24 lg:px-8 xl:pl-12">
                            <div className="mx-auto max-w-lg lg:max-w-none">
                                <form onSubmit={handleSubmit} encType="multipart/form-data" className="grid grid-cols-1 gap-y-6">
                                    <div>
                                        <label htmlFor="name" className="sr-only">
                                            Name
                                        </label>
