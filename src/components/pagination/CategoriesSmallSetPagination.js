...
function CategoriesSmallSetPagination({get_articles_list_page, articles_list, count, category_id}){
    ...
    const visitPage = (page) => {
        ...
        setCurrentPage(page);
        setActive(page);
        get_articles_list_page(category_id,page)
    }
    ...
    const previous_number = () => {
      // window.scrollTo(0, 0);
        if (currentPage !== 1) {
            ...
            get_articles_list_page(category_id,currentPage-1)
        }
    };
